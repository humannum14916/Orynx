...
## Using Orynx
This section is on how to interact with the Orynx language using Javascript. If you just want to  start writing Orynx programs, [THIS SECTION NEEDS TO BE DONE].
